...
func _on_Continue_pressed():
	...
	if file.file_exists(save_path):
		...
		if error == OK:
			...
			Times.world1_7Time = player_data["world1_7Time"]
			Times.world1_8Time = player_data["world1_8Time"]
			Times.world1_9Time = player_data["world1_9Time"]
			Times.world1_10Time = player_data["world1_10Time"]
			...
			Times.world3_1Time = player_data["world3_1Time"]
			Times.world3_2Time = player_data["world3_2Time"]
			Times.world3_3Time = player_data["world3_3Time"]
			Times.world3_4Time = player_data["world3_4Time"]
			Times.world3_5Time = player_data["world3_5Time"]
			Times.world3_6Time = player_data["world3_6Time"]
			Times.world3_7Time = player_data["world3_7Time"]
			Times.world3_8Time = player_data["world3_8Time"]
			Times.world3_9Time = player_data["world3_9Time"]
			Times.world3_10Time = player_data["world3_10Time"]
